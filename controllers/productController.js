...
exports.editProductPost = async (req, res) => {
  try {
    const { productName, category, price, productDetails, stock, id } =
      req.body;
    ...
    if (req.files && Object.keys(req.files).length > 0) {
      ...
      image2 = imageFiles.image2
        ? imageFiles.image2[0].filename
        : data.image.image2;
      image3 = imageFiles.image3
        ? imageFiles.image3[0].filename
        : data.image.image3;
      image4 = imageFiles.image4
        ? imageFiles.image4[0].filename
        : data.image.image4;
    }
